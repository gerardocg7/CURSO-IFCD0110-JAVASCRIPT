...
if (mysqli_num_rows($result)) {
    ...
    http_response_code(405); // ...no permitimos crear el nuevo usuario
    exit;
}
$result = mysqli_query($conn, "INSERT INTO user (login, password) VALUES ('$user','$password')");
if (!$result) {
    // Si no podemos recoger los resultados...
    echo 'No se ha podido dar de alta el usuario';
    http_response_code(500); //...nos daría un error de servidor
    exit;
} // Si podemos recoger los datos correctamente, creamos el nuevo usuario
